<?php 
	...
	class CocktailcocktailcategoriesRepositoryBase  {
		protected $_pdo;
		protected $_lang;
		...
		public static function getAll($Connection) {
			...
			$query = $qb->select()->from(array("cocktailcocktailcategories"))->getQuery();
			try {
				$result = $Connection->selectTable($query);
				$array = array();
				foreach ($result as $object){
					$o = new Entity\Cocktailcocktailcategories();
					$o->fillObject($object);
					$array[] = $o;
				}
				return $array;
		...
		public function getById($id) {
			$query = $this->_queryBuilder->select()->from(array("cocktailcocktailcategories"))
											->where(array(array("link" => "", "left" => "id", "operator" => "=", "right" => $id)))->getQuery();
			try {
				$properties = $this->_pdoHelper->select($query);
				$object = new Entity\Cocktailcocktailcategories();
		...
		public function delete($id) {
			$query = $this->_queryBuilder->delete("cocktailcocktailcategories")
		...
		public function add($properties) {
			$query = $this->_queryBuilder->insert("cocktailcocktailcategories", array('name' => $properties["name"], ))->getQuery();
			try {
				return $this->_pdo->Query($query);
			}
			catch(PDOException $e){
		...
		public function update($id, $properties) {
			$query = $this->_queryBuilder->update("cocktailcocktailcategories", array('name' => $properties["name"], ))->where(array(array("link" => "", "left" => "id", "operator" => "=", "right" => $id )))->getQuery();
			try {
				return $this->_pdo->Query($query);
			}
			catch(PDOException $e){
