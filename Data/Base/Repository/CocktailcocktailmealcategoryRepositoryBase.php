<?php 
	...
	class CocktailcocktailmealcategoryRepositoryBase  {
		protected $_pdo;
		protected $_lang;
		...
		public static function getAll($Connection) {
			...
			$query = $qb->select()->from(array("cocktailcocktailmealcategory"))->getQuery();
			try {
				$result = $Connection->selectTable($query);
				$array = array();
				foreach ($result as $object){
					$o = new Entity\Cocktailcocktailmealcategory();
					$o->fillObject($object);
					$array[] = $o;
				}
				return $array;
		...
		public function getById($id) {
			$query = $this->_queryBuilder->select()->from(array("cocktailcocktailmealcategory"))
											->where(array(array("link" => "", "left" => "id", "operator" => "=", "right" => $id)))->getQuery();
			try {
				$properties = $this->_pdoHelper->select($query);
				$object = new Entity\Cocktailcocktailmealcategory();
		...
		public function delete($id) {
			$query = $this->_queryBuilder->delete("cocktailcocktailmealcategory")
		...
		public function update($id, $properties) {
			$query = $this->_queryBuilder->update("cocktailcocktailmealcategory", array('name' => $properties["name"], 'price' => $properties["price"], ))->where(array(array("link" => "", "left" => "id", "operator" => "=", "right" => $id )))->getQuery();
			try {
				return $this->_pdo->Query($query);
			}
			catch(PDOException $e){
